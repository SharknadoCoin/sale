...
export { abi as LpBond2Contract } from "./bonds/bondContract.json";
export { abi as customBond } from "./bonds/customBond.json";
export { abi as customBondV2 } from "./bonds/customBondV2.json";
export { abi as wbnbBondV2 } from "./bonds/stableBondV2.json";
export { abi as customTreasury } from "./bonds/customTreasury.json";
...
export { abi as erc20abi } from "./reserves/erc20abi.json";
