...
import PrizeButton from "./prize-button";
...
function Header({ handleDrawerToggle, drawe }: IHeader) {
    ...
    const isZapShow = useMediaQuery("(max-width: 480px)");
    const isPrizeShow = useMediaQuery("(max-width: 480px)");
    const isSaleShow = useMediaQuery("(max-width: 480px)");
            ...
            <AppBar position="sticky" className={classes.appBar} elevation={0}>
                <Toolbar disableGutters className="dapp-topbar">
                    ...
                    <div className="dapp-topbar-btns-wrap">
                        ...
                        {/* {!isSaleShow && <SaleButton />} */}
                        {/* {!isZapShow && <ZapButton />} */}
                        {/* {!isWrapShow && <WrapButton />} */}
                        {/* {!isPrizeShow && <PrizeButton />} */}
                        <ConnectButton />
                    </div>
                </Toolbar>
            </AppBar>
