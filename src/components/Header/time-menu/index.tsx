...
function TimeMenu() {
    ...
    const SHARKO_ADDRESS = addresses.SHARKO_ADDRESS;
                ...
                {({ TransitionProps }) => (
                    <Fade {...TransitionProps} timeout={200}>
                        <div className="tooltip">
                            <Link className="tooltip-item" href={`https://www.traderjoexyz.com/#/trade?inputCurrency=&outputCurrency=${SHARKO_ADDRESS}`} target="_blank">
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("TIME", SHARKO_ADDRESS)}>
                                        <p>TIME</p>
                                    </div>
